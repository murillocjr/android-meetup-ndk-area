...
Java_com_example_android_camera2basic_CameraActivity_stringFromJNI( JNIEnv* env, jobject thiz )
{
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = (*env)->FindClass(env,
                                    "com/example/android/camera2basic/JniHandler");
...
Java_com_example_android_camera2basic_CameraActivity_startTicks(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_android_camera2basic_CameraActivity_StopTicks(JNIEnv *env, jobject instance) {
